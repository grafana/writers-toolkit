...
Refer to the guide and update it as needed when a subject matter expert (SME) answers a question about Markdown syntax, or a decision is made about how to apply Markdown.

The static site generator [Hugo](https://gohugo.io/) generates the web site for the documentation.
