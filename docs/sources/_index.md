...
Use it as the source of truth for voice, tone, grammar, style, templates, and much, much more.
...
If you're new to the guide, start with the [Get started](https://grafana.com/docs/writers-toolkit/get-started/) section.
