...
Shortcodes are snippets used in content files that Hugo renders with using a predefined template.

Templates are defined in the `layouts/shortcodes` directory.
