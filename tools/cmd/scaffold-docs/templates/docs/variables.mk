...
# The following PROJECTS value mounts content into the ⟨⟨⟨ .RepoName ⟩⟩⟩ project, at the "latest" version, which is the default if not explicitly set.
# This results in the content being served at /docs/⟨⟨⟨ .RepoName ⟩⟩⟩/latest/.
...
PROJECTS := ⟨⟨⟨ .RepoName ⟩⟩⟩::$(notdir $(basename $(shell git rev-parse --show-toplevel)))
