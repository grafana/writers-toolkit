local newWord(word, affixes, po) = {
  ...
  product: false,
  // replaces is a string representing the regular expression that the word replaces.
  replaces: '',
};

{
  words: [
    ...
    newWord('Alertmanager', 'MS', 'noun') { replaces: '(?:alert[Mm]anager|[Aa]lert [Mm]anager|AlertManager)' },
    ...
    newWord('email', 'DS', 'verb'),
    newWord('email', 'S', 'noun') { replaces: '(?:e-mail|Email|E-mail)' },
    ...
    newWord('Git', '', 'noun') { product: true, replaces: 'git' },
    newWord('GitHub', '', 'noun') { product: true, replaces: '(?:[gG]itHub]|Github)' },
    ...
    newWord('Grafana', '', 'noun') { product: true, replaces: 'grafana' },
    ...
    newWord('Jsonnet', 'M', 'noun') { replaces: 'jsonnet' },
    ...
    newWord('Phlare', 'M', 'noun') { product: true, replaces: 'phlare' },
    ...
    newWord('Prometheus', '', 'noun') { product: true, replaces: 'prometheus' },
    ...
    newWord('query-frontend', 'MS', 'noun') { replaces: 'query frontend' },
    newWord('RAM', '', 'noun') { acronym: true, established_acronym: true },
    newWord('React', 'M', 'noun'),
    newWord('redirection', 'S', 'noun'),
    newWord('Redis', '', 'noun') { product: true, replaces: 'redis' },
    ...
    newWord('URL', '', 'noun') { acronym: true, established_acronym: true, replaces: 'url' },
