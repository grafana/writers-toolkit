...
Capitalize only the first word in the title, the first word in a subheading after a colon, and any proper nouns. [Product names]({{< relref "../capitalization-punctuation#capitalizing-proper-nouns" >}}) are considered proper nouns.
