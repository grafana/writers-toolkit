...
| LAUNCH TIER (OPTIONAL) | Marketing launch tier, to say how much marketing support this feature needs. | For a rubric, refer to the [Release Tier Matrix](https://wiki.grafana-ops.net/w/index.php/Marketing/Product_Marketing/Product_Release_Tier_Matrix).<br></br>For examples, refer to the [Upcoming Products/Features Tracker + Calendar Google Sheet](https://docs.google.com/spreadsheets/d/1E81c1OGisYtGWpLlHm7rBMOYKk-0N1akHyNbPqaANFY/edit?gid=801299949#gid=801299949).<br></br>If you're not sure what level to use, ask in the **#product-marketing** Slack channel. |
